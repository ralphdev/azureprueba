...
namespace cursoazuredevops.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly cursoazuredevopsDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = cursoazuredevopsConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(cursoazuredevopsDbContext context)
        {
            _context = context;
        }
